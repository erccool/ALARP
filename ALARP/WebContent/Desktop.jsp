...
Is this true?	</label>
	<input type="email" class="fform-group mb-2" id="ques13a" name="q2" readonly> 		
 	...
 	<div class = "row" id = "comment"><div class = "col-md-6 col-md-offset-3">
 	<label for="email"> 	 	
3.1Current available AP and approved company contractors do not have appropriate visa or diplomatic ties to carry out an inspection. i.e Israels, Qatar, Iran and etc. 
Is this true?	</label>
...
Is this true? 	</label>
	<input type="email" class="fform-group mb-2" id="ques21a" name="q2" readonly> 		 	
 	...
 	<div class = "col-md-6 col-md-offset-3">
 	<div class = "col-md-9 col-sm-3 col-xs-12 ">
		<button onClick = "Yes21()" type="submit" class="btn  btn-warning signup-btn active">Yes</button>
	
		</div>  
		
		<div class = "col-md-3 col-sm-3 col-xs-12 ">
		<button type="submit" class="btn  btn-danger signup-btn active" data-toggle="modal" data-target="#Modal21">No</button>
	</div>  
	</div>
 	</div>
...
Is this true? 	</label>
	<input type="email" class="fform-group mb-2" id="ques22a" name="q2" readonly> 		 	
 	...
 	<div class = "col-md-6 col-md-offset-3">
 	<div class = "col-md-9 col-sm-3 col-xs-12 ">
		<button onClick = "Yes22()" type="submit" class="btn  btn-warning signup-btn active">Yes</button>
	
		</div>  
		
		<div class = "col-md-3 col-sm-3 col-xs-12 ">
		<button type="submit" class="btn  btn-danger signup-btn active" data-toggle="modal" data-target="#Modal22">No</button>
	</div>  
	</div>
 	</div>
